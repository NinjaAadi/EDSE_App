...
class AddNonTeachingStaffProfile extends StatelessWidget {
  const AddNonTeachingStaffProfile({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final addNonTeachingStaffBloc =
        AddNonTeachingStaffProfileProvider.of(context);

    return StreamBuilder(
      stream: addNonTeachingStaffBloc.preSelectionStream,
        ...
        if (!snapshot.hasData) {
          ...
          void filePicker() async {
            try {
              ...
              addNonTeachingStaffBloc
                  .addNonTeachingStaffProfile({"file": file});
            } catch (error) {
              print(error);
            }
          }
          ...
          void _onSelectionChanged(DateRangePickerSelectionChangedArgs args) {
            ...
            addNonTeachingStaffBloc.addNonTeachingStaffProfile({
          ...
          //Submit function
          submit() async {
            return await addNonTeachingStaffBloc.submitProfile();
          }
                ...
                child: Column(
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: StreamBuilder(
                          stream: addNonTeachingStaffBloc
                              .nonTeachingStaffProfileAddStream,
                          builder: (context,
                    ...
                    Align(
                      ...
                      child: MultiSelectDialogField(
                        ...
                        onConfirm: (List<RoleModel> values) {
                          ...
                          addNonTeachingStaffBloc
                              .addNonTeachingStaffProfile({"role": roles});
                        },
                      ),
                    ),
                    Container(margin: EdgeInsets.only(top: 20.0)),
                    Align(
                      alignment: Alignment.centerLeft,
                      child: StreamBuilder(
                        stream: addNonTeachingStaffBloc.buttonValueStream,
