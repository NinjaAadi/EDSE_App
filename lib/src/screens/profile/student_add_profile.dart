...
class AddStudentProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      stream: addStudentProfileBloc.preSelectionStream,
        ...
        if (!snapshot.hasData) {
          ...
          void filePicker() async {
            try {
              ...
              addStudentProfileBloc.addStudentProfile({"file": file});
            } catch (error) {
              print(error);
            }
          }
          ...
          void _onSelectionChanged(DateRangePickerSelectionChangedArgs args) {
            ...
            addStudentProfileBloc.addStudentProfile({
          ...
          //Submit function
          submit() async {
            return await addStudentProfileBloc.submitProfile();
          }
                ...
                child: Column(
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: StreamBuilder(
                          stream: addStudentProfileBloc.studentProfileAddStream,
                          builder: (context,
                      ...
                      child: TextField(
                        onChanged: ((value) => {
                              addStudentProfileBloc
                                  .addStudentProfile({"fullName": value})
                            }),
                        decoration:
                    ...
                    Align(
                      ...
                      child: TextField(
                        onChanged: ((value) => {
                              addStudentProfileBloc
                                  .addStudentProfile({"address": value})
                            }),
                    ...
                    Align(
                      ...
                      child: TextField(
                        onChanged: ((value) => {
                              addStudentProfileBloc
                                  .addStudentProfile({"phoneNumber": value})
                            }),
                        decoration:
                    ...
                    Align(
                      ...
                      child: TextField(
                        onChanged: ((value) => {
                              addStudentProfileBloc
                                  .addStudentProfile({"fatherName": value})
                            }),
                        decoration:
                            InputDecoration(labelText: "Enter father's name"),
                      ),
                    ),
                    Container(margin: EdgeInsets.only(top: 10.0)),
                    Align(
                      ...
                      child: TextField(
                        onChanged: ((value) => {
                              addStudentProfileBloc
                                  .addStudentProfile({"motherName": value})
                            }),
                        decoration:
                            InputDecoration(labelText: "Enter mother's name"),
                      ),
                    ),
                    Container(margin: EdgeInsets.only(top: 10.0)),
                    Align(
                      ...
                      child: TextField(
                        onChanged: ((value) => {
                              addStudentProfileBloc
                                  .addStudentProfile({"parentNumber": value})
                            }),
                        decoration: InputDecoration(
                            labelText: "Enter parent's phone number"),
                      ),
                    ),
                    Container(margin: EdgeInsets.only(top: 20.0)),
                    Align(
                      ...
                      child: StreamBuilder(
                        ...
                        builder: (context,
                          ...
                          return DropdownButton(
                            ...
                            onChanged: (value) {
                              addStudentProfileBloc
                                  .addStudentProfile({"gender": value});
                            },
                          );
                        },
                      ),
                    ...
                    Align(
                      ...
                      child: MultiSelectDialogField(
                        ...
                        onConfirm: (List<CourseModel> values) {
                          ...
                          addStudentProfileBloc
                              .addStudentProfile({"courses": courses});
                        },
                      ),
                    ),
                    Container(margin: EdgeInsets.only(top: 20.0)),
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: StreamBuilder(
                        stream: addStudentProfileBloc.buttonValueStream,
